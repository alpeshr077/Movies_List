...
import com.example.movies_list.databinding.FragmentUpcomingBinding
import retrofit2.Call
import retrofit2.Callback
import retrofit2.Response


class Playing_fragment : Fragment() {

    var page = 1
    lateinit var binding: FragmentPlayingFragmentBinding
    ...
    override fun onCreateView(
        ...
        binding = FragmentPlayingFragmentBinding.inflate(layoutInflater)
    ...
    private fun callApi(page: Int) {
        var api = ApiClient.getApiClient()?.create(ApiInterface_1::class.java)
